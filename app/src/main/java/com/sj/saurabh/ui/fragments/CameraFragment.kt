...
import com.sj.saurabh.databinding.CameraUiContainerBinding
import com.sj.saurabh.databinding.FragmentCameraBinding
import com.sj.saurabh.ui.activities.KEY_EVENT_ACTION
import com.sj.saurabh.ui.activities.KEY_EVENT_EXTRA
...
class CameraFragment : Fragment() {
    ...
    private var bindingFragCamera: FragmentCameraBinding? = null

    private val fragmentCameraBinding get() = bindingFragCamera!!
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        bindingFragCamera = FragmentCameraBinding.inflate(inflater, container, false)
        if (!PermissionsFragment.hasPermissions(requireContext())) {
            Navigation.findNavController(requireActivity(), R.id.fragment_container).navigate(R.id.navigation_PermissionsFragment)
        }
...
//            observeCameraState(camera?.cameraInfo!!)
    ...
    private fun updateCameraUi() {
        ...
        // for saving images in gallery and get data of gallery
...
//            takePhoto()
            ...
            imageCapture?.let { imageCapture ->
                ...
                val outputOptions = ImageCapture.OutputFileOptions.Builder(
                    requireContext().contentResolver, MediaStore.Images.Media.EXTERNAL_CONTENT_URI, contentValues).build()
    ...
    companion object {
        private const val TAG = "CameraXSaurabh"
        private const val FILENAME = "yyyy-MM-dd-HH-mm-ss-SSS"
        private const val PHOTO_TYPE = "image/png"
